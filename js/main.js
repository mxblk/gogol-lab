...
////team catds
$('.team__title__dot, .team__btn').click(function(){
  var remCl = function(){
...
///////////////////////////
const showDialog = () => {
  document.getElementById('burger__menu');//.classList.add('active');
...
$(function(){
  ...
  $('.header__burger').click(function(event){
    ...
    }else if ($('.burger__menu').hasClass('active')) {
        $('.header__burger, .burger__menu').toggleClass('active');
  ...
  $('.header__link, .burger__link, .burger__sublink, .header__logo').click(function(){
